-- CORREÇÃO: Função get_personal_trainers_admin_view
-- PROBLEMA: A função no banco de dados estava retornando apenas 14 campos, mas o código TypeScript esperava 17 campos
-- SOLUÇÃO: Deletar a função antiga e criar uma nova com os campos corretos
