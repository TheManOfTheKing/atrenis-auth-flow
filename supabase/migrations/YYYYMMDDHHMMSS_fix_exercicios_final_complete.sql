-- SCRIPT COMPLETO E DEFINITIVO PARA CORRIGIR A TABELA EXERCICIOS
-- Baseado na estrutura atual da tabela e nos campos necessários do código

-- 1. Adicionar coluna 'publico' que está faltando
...
-- 3. Atualizar o índice para usar o novo nome da coluna
...
-- 5. Remover todas as políticas existentes para recriar
...
-- 7. Criar a RPC function search_exercicios (necessária para o hook useExercises)
...
-- 8. Atualizar exercícios existentes para serem públicos (se não tiverem personal_id)
UPDATE public.exercicios 
SET publico = TRUE 
WHERE personal_id IS NULL;

-- 9. Inserir exercícios públicos de exemplo se a tabela estiver vazia
...
SELECT * FROM (VALUES
  (NULL, 'Agachamento Livre', 'Exercício fundamental para pernas e glúteos. Mantenha as costas retas e desça até as coxas ficarem paralelas ao chão.', 'Quadríceps', 'Peso corporal', 'Iniciante', NULL, NULL, TRUE),
  (NULL, 'Flexão de Braço', 'Exercício clássico para peito, ombros e tríceps. Mantenha o corpo alinhado e desça até quase tocar o chão.', 'Peito', 'Peso corporal', 'Iniciante', NULL, NULL, TRUE),
  (NULL, 'Prancha', 'Exercício isométrico para fortalecer o core. Mantenha o corpo em linha reta da cabeça aos pés.', 'Abdômen', 'Peso corporal', 'Iniciante', NULL, NULL, TRUE),
  (NULL, 'Supino Reto', 'Exercício fundamental para desenvolvimento do peito. Deite no banco e empurre a barra para cima.', 'Peito', 'Barra', 'Intermediário', NULL, NULL, TRUE),
  (NULL, 'Puxada Frontal', 'Exercício para desenvolvimento das costas. Puxe a barra em direção ao peito.', 'Costas', 'Cabo', 'Intermediário', NULL, NULL, TRUE),
  (NULL, 'Desenvolvimento com Halteres', 'Exercício para ombros. Levante os halteres acima da cabeça.', 'Ombros', 'Halteres', 'Intermediário', NULL, NULL, TRUE),
  (NULL, 'Bicicleta Ergométrica', 'Exercício cardiovascular de baixo impacto.', 'Cardio', 'Máquina', 'Iniciante', NULL, NULL, TRUE),
  (NULL, 'Prancha Isométrica', 'Exercício isométrico para core completo.', 'Abdômen', 'Peso corporal', 'Iniciante', NULL, NULL, TRUE)
...
-- 10. Verificar se a tabela treino_exercicios existe (necessária para a funcionalidade de treinos)
...
-- 11. Verificar se a tabela treinos existe
...
-- 12. Adicionar comentários explicativos
...
BEGIN
  ...
  RAISE NOTICE '- Tabelas relacionadas (treinos, treino_exercicios) verificadas';
  RAISE NOTICE '========================================';
END $$;
