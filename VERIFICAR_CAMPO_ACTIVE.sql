-- Script para verificar se existe algum campo com valor 'active' no banco
...
-- 3. Verificar se há dados usando 'active' em qualquer coluna de texto
SELECT 
    'profiles' as tabela,
...
-- 4. Verificar se há dados usando 'active' em outras colunas de texto
SELECT 
    'profiles' as tabela,
    'nome' as coluna,
    nome as valor,
...
-- 5. Verificar se há dados usando 'active' na coluna motivo_desativacao
SELECT 
    'profiles' as tabela,
...
-- 6. Verificar se há dados usando 'active' na tabela plans
SELECT 
    'plans' as tabela,
    'nome' as coluna,
    nome as valor,
...
-- 8. Verificar se há dados usando 'active' em qualquer coluna JSONB
SELECT 
    'plans' as tabela,
    'recursos' as coluna,
...
-- 9. Verificar se há dados usando 'active' na tabela treinos
SELECT 
    'treinos' as tabela,
    'nome' as coluna,
    nome as valor,
...
-- 10. Verificar se há dados usando 'active' na tabela exercicios
SELECT 
...
-- 14. Verificar se há dados usando 'active' na tabela aluno_status_history
SELECT 
...
-- 15. Verificar se há dados usando 'active' na tabela personal_status_history
SELECT 
    'personal_status_history' as tabela,
    'motivo' as coluna,
    motivo as valor,
    COUNT(*) as count
FROM public.personal_status_history 
WHERE motivo ILIKE '%active%'
GROUP BY motivo;

-- 16. Verificar se há dados usando 'active' na tabela plan_status_history
SELECT 
...
-- 17. Verificar se há dados usando 'active' na tabela subscription_history
SELECT 
...
-- 18. Verificar se há dados usando 'active' na tabela subscription_history (status_assinatura)
SELECT 
    'subscription_history' as tabela,
    'status_assinatura' as coluna,
    status_assinatura as valor,
...
-- 19. Verificar se há dados usando 'active' na tabela subscription_history (acao)
SELECT 
    'subscription_history' as tabela,
    'acao' as coluna,
    acao as valor,
...
-- 20. Verificar se há dados usando 'active' na tabela subscription_history (observacoes)
SELECT 
    'subscription_history' as tabela,
